...
export class PostController {
    ...
    async create(req: Request, res: Response) {
        try {
            ...
            const post = await this.postService.create(payload, req.user!.userId);
    ...
    async update(req: Request, res: Response) {
        try {
            ...
            const post = await this.postService.update(id, payload, req.user!.userId);
    ...
    async createComment(req: Request, res: Response) {
        try {
            ...
            const comment = await this.commentService.create(postId, payload, req.user!.userId);
            ...
            if (error.message === 'Parent comment not found')
                return res.status(404).json({ message: error.message });
            if (
                error.message === 'Cannot reply to a reply' ||
    ...
    async updateComment(req: Request, res: Response) {
        try {
            ...
            const comment = await this.commentService.update(commentId, payload, req.user!.userId);
